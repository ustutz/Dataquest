...
class Script:
	...
	def main():
		...
		result4 = ((a == 5) or ((b == 5)))
		result5 = ((a > b) or ((a == 10)))
		print(("result1 " + Std.string(result1)))
		print(("result2 " + Std.string(result2)))
		print(("result3 " + Std.string(result3)))
		print(("result4 " + Std.string(result4)))
		print(("result5 " + Std.string(result5)))
