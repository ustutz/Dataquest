...
@:pythonImport( 'numpy' ) extern class NumPy {
	...
	public function sum( ?a:NumPy, axis:String = 'None', dtype:String = 'None', out:String = 'None', keepdims:Bool = false ):Dynamic;
	public function mean( ?a:NumPy, axis:String = 'None', dtype:String = 'None', out:String = 'None', keepdims:Bool = false ):Dynamic;
