class Script:
	...
	def main():
		...
		first_500 = ((crime_rates[0] if 0 < len(crime_rates) else None) > 500)
		first_749 = ((crime_rates[0] if 0 < len(crime_rates) else None) >= 749)
		first_last = ((crime_rates[0] if 0 < len(crime_rates) else None) >= python_internal_ArrayImpl._get(crime_rates, (len(crime_rates) - 1)))
		print(str(first_500))
		print(str(first_749))
