...
class Script:
	...
	_hx_statics = ["main", "get_five_elements"]

	@staticmethod
	def main():
		five_elements = Script.get_five_elements()
		cities_list = []
		cities_list.append(python_internal_ArrayImpl._get((five_elements[0] if 0 < len(five_elements) else None), 0))
		cities_list.append(python_internal_ArrayImpl._get((five_elements[1] if 1 < len(five_elements) else None), 0))
		cities_list.append(python_internal_ArrayImpl._get((five_elements[2] if 2 < len(five_elements) else None), 0))
		cities_list.append(python_internal_ArrayImpl._get((five_elements[3] if 3 < len(five_elements) else None), 0))
		cities_list.append(python_internal_ArrayImpl._get((five_elements[4] if 4 < len(five_elements) else None), 0))
		print(str(cities_list))

	@staticmethod
	def get_five_elements():
		...
		while (_g < len(rows)):
			...
			_g = (_g + 1)
			elements = row.split(",")
			final_data.append(elements)
		return final_data[0:5]
