...
class Main:
    ...
    def main():
        mu = 100
        sigma = 15
        x = (mu + ((sigma * Reflect.field(numpy_Numpy_Module,"random").randn(10000))))
        kwArgs = dict()
        kwArgs["normed"] = 1
        kwArgs["facecolor"] = "g"
        kwArgs["alpha"] = 0.75
        this1 = kwArgs
        n = matplotlib_pyplot_Pyplot_Module.hist(x,50,**this1)
        matplotlib_pyplot_Pyplot_Module.xlabel("Smarts")
        matplotlib_pyplot_Pyplot_Module.ylabel("Probability")
        matplotlib_pyplot_Pyplot_Module.title("Histogram of IQ")
        matplotlib_pyplot_Pyplot_Module.text(60,.025,r'$\mu=100,\ \sigma=15$')
        kwArgs1 = dict()
        this2 = kwArgs1
        matplotlib_pyplot_Pyplot_Module.axis([40, 160, 0, 0.03],**this2)
