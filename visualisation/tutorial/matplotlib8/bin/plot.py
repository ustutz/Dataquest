...
class Main:
    ...
    @staticmethod
    def main():
        y = Reflect.field(numpy_Numpy_Module,"random").normal(loc = 0.5, scale = 0.4, size = 1000)
        y = y[(y > 0) & (y < 1)]
        y.sort()
        x = numpy_Numpy_Module.arange(len(y))
        kwArgs = dict()
        this1 = kwArgs
        matplotlib_pyplot_Pyplot_Module.figure(1,**this1)
        kwArgs1 = dict()
        this2 = kwArgs1
        matplotlib_pyplot_Pyplot_Module.subplot(221,**this2)
        kwArgs2 = dict()
        this3 = kwArgs2
        matplotlib_pyplot_Pyplot_Module.plot(x,y,**this3)
        kwArgs3 = dict()
        this4 = kwArgs3
        matplotlib_pyplot_Pyplot_Module.yscale("linear",**this4)
        matplotlib_pyplot_Pyplot_Module.title("linear")
        matplotlib_pyplot_Pyplot_Module.grid(True)
        kwArgs4 = dict()
        this5 = kwArgs4
        matplotlib_pyplot_Pyplot_Module.subplot(222,**this5)
        kwArgs5 = dict()
        this6 = kwArgs5
        matplotlib_pyplot_Pyplot_Module.plot(x,y,**this6)
        kwArgs6 = dict()
        this7 = kwArgs6
        matplotlib_pyplot_Pyplot_Module.yscale("log",**this7)
        matplotlib_pyplot_Pyplot_Module.title("log")
        matplotlib_pyplot_Pyplot_Module.grid(True)
        kwArgs7 = dict()
        this8 = kwArgs7
        matplotlib_pyplot_Pyplot_Module.subplot(223,**this8)
        tmp = (y - y.mean())
        kwArgs8 = dict()
        this9 = kwArgs8
        matplotlib_pyplot_Pyplot_Module.plot(x,tmp,**this9)
        kwArgs9 = dict()
        kwArgs9["linthreshy"] = 0.05
        this10 = kwArgs9
        matplotlib_pyplot_Pyplot_Module.yscale("symlog",**this10)
        matplotlib_pyplot_Pyplot_Module.title("symlog")
        matplotlib_pyplot_Pyplot_Module.grid(True)
        kwArgs10 = dict()
        this11 = kwArgs10
        matplotlib_pyplot_Pyplot_Module.subplot(224,**this11)
        kwArgs11 = dict()
        this12 = kwArgs11
        matplotlib_pyplot_Pyplot_Module.plot(x,y,**this12)
        kwArgs12 = dict()
        this13 = kwArgs12
        matplotlib_pyplot_Pyplot_Module.yscale("logit",**this13)
        matplotlib_pyplot_Pyplot_Module.title("logit")
        matplotlib_pyplot_Pyplot_Module.grid(True)
